...
type Article struct {
	...
	ArticleID string `json:"article_id,omitempty" gorm:"index:idx_article_id,unique;comment:文章ID，便于url访问"`
...
func UpdateArticleByID(articleID string, a *Article) error {
